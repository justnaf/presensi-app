...
class UpdateEventRequest extends FormRequest
{
    ...
    {
        // Sebaiknya Anda menerapkan logic otorisasi di sini.
        // Contoh: Memastikan user yang login adalah pemilik event atau admin.
    ...
    {
        return [
            // 'sometimes' berarti validasi hanya jika field ini ada di request
            ...
            'max_attendees' => 'sometimes|required|integer|min:0',
            'start_date' => 'sometimes|required|date',
            'end_date' => 'sometimes|required|date|after_or_equal:start_date',
            'category_id' => 'nullable|exists:event_categories,id',
            'type' => 'sometimes|required|string|max:255',
            'attendance_mode' => 'sometimes|required|in:ticketing,barcode',
        ];
    }
