...
<template>
    ...
    <PublicLayout>
        ...
        <div
            ...
            <div
                class="mx-auto max-w-md text-center lg:mx-0 lg:flex-shrink-0 lg:py-32 lg:text-left">
                <h1
                    class="text-4xl font-bold tracking-tight text-white sm:text-6xl">
                    Temukan & Ikuti Kegiatan Favoritmu</h1>
                <p
                    class="mt-6 text-lg leading-8 text-gray-300">
                    Platform manajemen event modern untuk
                    pendaftaran yang mudah, absensi cepat,
            ...
            <div
                class="relative mx-auto mt-16 h-80 w-full max-w-2xl lg:mt-0 lg:h-auto">
                <img class="absolute inset-0 h-full w-full object-cover"
                    :src="'/logo/LogoSintesaHP.jpg'"
                    alt="App screenshot" />
            </div>
        </div>
        ...
        <section class="py-24 sm:py-32">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl text-center">
                    <h2
                        class="text-base leading-7 font-semibold text-indigo-600 dark:text-indigo-400">
                        Semua Jadi Mudah</h2>
                    <p
                        class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl dark:text-gray-100">
                        Keunggulan Aplikasi Kami</p>
                </div>
                <div
                    ...
                    <dl
                        ...
                        <div class="flex flex-col">
                            <dt
                                class="flex items-center gap-x-3 text-base leading-7 font-semibold">
                                <Ticket
                            ...
                            <dd
                                ...
                                <p class="flex-auto">Daftar
                                    ke event favoritmu hanya
                                    dengan beberapa klik.
                                    Dapatkan e-tiket instan
                                    tanpa repot.</p>
                            </dd>
                        </div>
                        <div class="flex flex-col">
                            ...
                            <dd
                                class="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600 dark:text-gray-300">
                                <p class="flex-auto">Gunakan
                                    QR Code untuk check-in
                                    di lokasi acara. Cepat,
                                    aman, dan mengurangi
                                    antrean.</p>
                            </dd>
                        </div>
                        <div class="flex flex-col">
                            ...
                            <dd
                                ...
                                <p class="flex-auto">
                                    ...
                                    akan datang dan yang
                                    sudah diikuti di satu
                                    tempat.
                                </p>
                            </dd>
                        </div>
        ...
        <!-- Informasi Kegiatan -->
        <section
            class="bg-gray-100 py-24 sm:py-32 dark:bg-gray-900/50">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div
                    ...
                    <h2
                        ...
                        Kegiatan Terbaru</h2>
                    <a href="#"
                        class="text-sm leading-6 font-semibold text-indigo-600 dark:text-indigo-400">Lihat
                        semua <span
                ...
                <div
                    ...
                    <article v-for="event in events"
                        ...
                        <Link
                            :href="route('kegiatan.show', { kegiatan: event.id })"
                            class="w-full">
                        <div class="relative w-full">
                            ...
                            <div v-else
                                class="flex aspect-[16/9] w-full items-center justify-center rounded-2xl bg-gray-100 dark:bg-gray-800">
                                <img src="https://placehold.co/600x400/e2e8f0/a0aec0?text=Event"
