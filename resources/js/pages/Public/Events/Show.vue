...
<template>
    ...
    <PublicLayout>
        ...
        <div
            class="relative isolate overflow-hidden bg-gray-500 px-6 py-14 text-center shadow-2xl sm:px-16 sm:py-12 dark:bg-gray-900">
        </div>
        ...
        <div class="bg-gray-50 dark:bg-gray-950">
            <div
                ...
                <div
                    class="grid grid-cols-1 gap-12 lg:grid-cols-3">
                    <div class="lg:col-span-1">
                        <div class="sticky top-24">
                            <img v-if="event.poster_image"
                                :src="`/storage/${event.poster_image}`"
                                :alt="event.name"
                                class="aspect-[3/4] w-full rounded-2xl object-cover shadow-lg" />
                            <div v-else
                                class="flex aspect-[3/4] w-full items-center justify-center rounded-2xl bg-gray-200 dark:bg-gray-800">
                                <img src="https://placehold.co/600x800/e2e8f0/a0aec0?text=Event"
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div
                            class="mt-8 space-y-4 rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
                            <div
                            ...
                            <div v-if="event.location_name"
                                ...
                                <div>
                                    ...
                                    <a v-if="event.location_url"
                                        ...
                                        <ExternalLink
                                            class="inline-block h-4 w-4 opacity-50 transition group-hover:opacity-100" />
                                    </a>
                                    <p v-else
                                        class="font-semibold text-gray-800 dark:text-gray-200">
                                        {{
                        ...
                        <div v-if="event.latitude && event.longitude"
                            ...
                            <div id="map-container"
                                class="z-0 mt-4 h-80 w-full rounded-lg shadow-md">
                            </div>
                        </div>
                        <div class="mt-12">
                            <div
                            ...
                            <div class="py-6">
                                ...
                                <div
                                    v-if="activeTab === 'rundown' && event.rundowns.length > 0">
                                    <ul role="list"
                                        class="space-y-4">
                                        <li v-for="(item, index) in event.rundowns"
                                            :key="index"
                                            class="flex gap-x-4">
                                            <div
                                            ...
                                            <div
                                                class="flex-auto rounded-md bg-white p-4 ring-1 ring-gray-200 dark:bg-gray-800 dark:ring-gray-700">
                                                <div
                                                    class="font-semibold">
                                                    {{
                                                        item.title
        ...
        <footer
            class="sticky bottom-0 z-10 border-t border-gray-200 bg-white/80 p-4 backdrop-blur-sm dark:border-gray-700 dark:bg-gray-800/80">
            <div
                class="mx-auto flex max-w-7xl items-center justify-end">
